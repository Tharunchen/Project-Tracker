...
<script type="text/javascript">
	...
	/masterpages/roledetails.jsp?slno="
				+ slno + "&type=deleteData";
	}
</script>
</head>
<body>
		...
		<div class="container p-4">
			...
			<form method="post" class="row align-items-center"
				...
				<div class="col-md-4 col-12 d-flex align-items-center gap-2">
					<label class="mb-0 fw-semibold">UserName:</label> <select
						name="username" class="form-control field-input" required>
						<option value="">Select-Username</option>
						<%
						for (RolesDetails u : SampleUtilitiess.getdropdownusername()) {
							String selected = (RoleAsingModels.getUsername() != null && u.getUsername().equals(RoleAsingModels.getUsername()))
							? "selected"
							: "";
						%>
				...
				<div class="col-md-4 col-12 d-flex align-items-center gap-2">
					<label class="mb-0 fw-semibold">Role:</label> <select name="role"
						...
						for (RolesDetails r : SampleUtilitiess.getroledropdown()) {
							...
							&& String.valueOf(r.getSlno()).equals(RoleAsingModels.getRoleid())) ? "selected" : "";
						%>
